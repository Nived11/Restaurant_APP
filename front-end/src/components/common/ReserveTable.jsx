      ...
      {isOpen && (
        <div className="fixed inset-0 z-[2000] flex items-end md:items-center justify-center p-0 md:p-6">
          ...
          <motion.div
            ...
            className="relative bg-white w-full md:max-w-4xl rounded-t-[2rem] md:rounded-[2rem] shadow-2xl overflow-hidden max-h-[85vh] md:max-h-[90vh] flex flex-col touch-none md:touch-auto"
          >
            <div className="relative pt-3 md:pt-6 pb-1 md:pb-3 px-6 text-center shrink-0">
              ...
              <button onClick={onClose} className="absolute right-4 top-4 md:right-6 md:top-6 p-2 bg-gray-50 hover:bg-primary/10 transition-colors rounded-full z-10">
