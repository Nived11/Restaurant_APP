  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <EditableField icon={Phone} label="Phone Number" value={settings?.phone} onChange={(val) => handleChange('phone', val)} onSave={onSave} />
       ...
       <EditableField 
          ...
          // ഇവിടെ handleNestedChange തന്നെ ഉപയോഗിക്കണം
        ...
        <EditableField 
          ...
          // ഇവിടെയും handleNestedChange ഉപയോഗിക്കുക
