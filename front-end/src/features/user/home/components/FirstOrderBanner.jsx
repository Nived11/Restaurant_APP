          ...
          <div className="relative z-10 px-5 sm:px-10 md:px-16 w-full flex justify-between items-center gap-4">
            ...
            >
              ...
              <div className="bg-primary border-2 md:border-[3px] border-black p-2 sm:p-4 md:p-6 shadow-[4px_4px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_rgba(0,0,0,1)] flex flex-col items-center justify-center min-w-[75px] sm:min-w-[120px] md:min-w-[160px] relative overflow-hidden">
                ...
                <div className="absolute top-0.5 right-0.5 md:top-1 md:right-1 flex gap-0.5 md:gap-1">
                  <div className="size-0.5 sm:size-1 md:size-2 bg-black rounded-full" />
                  <div className="size-0.5 sm:size-1 md:size-2 bg-black rounded-full" />
                </div>
                
                <span className="text-black font-bold text-[8px] sm:text-[11px] md:text-sm uppercase leading-none">Get</span>
                <span className="text-black font-black text-xl sm:text-4xl md:text-5xl lg:text-6xl leading-none my-0.5 md:my-1">20%</span>
                <span className="text-black font-black text-[8px] sm:text-[12px] md:text-base lg:text-lg leading-none border-t-[1px] md:border-t-2 border-black pt-0.5 md:pt-1">OFF</span>
              </div>

              {/* Sticker Tail (Responsive sizes) */}
