                  ...
                  <AnimatePresence>
                    {isActive && (
                      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
                        ...
                        <button className="flex items-center gap-2 bg-primary text-black px-5 py-2.5 md:px-7 md:py-3 rounded-xl text-[10px] md:text-xs font-black uppercase shadow-xl hover:bg-white transition-all">
