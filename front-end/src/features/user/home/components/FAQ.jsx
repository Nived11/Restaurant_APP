      ...
      <div className="max-w-[1200px] mx-auto px-5 md:px-10">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20">
          ...
          <div className="lg:w-1/3 lg:sticky lg:top-28 h-fit">
            ...
            <p className="text-gray-500 font-bold uppercase text-[9px] md:text-xs mt-2 md:mt-4 tracking-widest leading-relaxed">
                ...
                >
                  ...
                  >
                    <span className="font-black uppercase text-xs md:text-base tracking-tight text-gray-900 pr-4">
                      {faq.question} {/* API field: question */}
                    </span>
                    <RiArrowDownSLine 
