    ...
    return (
        <div className="fixed inset-0 z-50 bg-black flex flex-col items-center justify-center text-center px-4">
            <div className="relative mb-8 scale-125">
                ...
                <ChefHat size={32} className="absolute top-8 left-8 text-[#f9a602] animate-bounce" />
            </div>
            <h2 className="text-[#f9a602] text-xl font-black tracking-[0.2em] uppercase">Placing Order...</h2>
            <p className="text-gray-500 text-[10px] mt-4 uppercase tracking-widest font-bold">Please don't refresh the page</p>
        </div>
    )
}
