      ...
      >
        <div className="max-w-sm w-full space-y-8">
          ...
          <AnimatePresence>
            {error && (
              <motion.div initial={{ opacity: 0, y: -5 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}
                className="p-3 bg-red-500/10 border border-red-500/30 rounded-xl flex items-center gap-3">
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col items-center lg:items-start gap-4">
            ...
            <button onClick={() => navigate('/signup')} className="group flex items-center gap-2 text-white cursor-pointer">
              <span className="font-black uppercase tracking-widest text-[11px] group-hover:text-[#f9a602]">Create Account</span>
              <div className="w-7 h-7 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-[#f9a602] transition-all">
